...
------------- | ------------- | -------------
[**client_get**](ClientApi.md#client_get) | **GET** /client | [ / ] List servers
[**client_permissions_get**](ClientApi.md#client_permissions_get) | **GET** /client/permissions | [ /permissions ] Show permissions


# **client_get**
> bool, date, datetime, dict, float, int, list, str, none_type client_get(accept)
...
with pterodactyl_client.ApiClient(configuration) as api_client:
    ...
    try:
        # [ / ] List servers
        api_response = api_instance.client_get(accept)
        pprint(api_response)
...
# **client_permissions_get**
> bool, date, datetime, dict, float, int, list, str, none_type client_permissions_get(accept, content_type)
...
with pterodactyl_client.ApiClient(configuration) as api_client:
    ...
    try:
        # [ /permissions ] Show permissions
        api_response = api_instance.client_permissions_get(accept, content_type)
        pprint(api_response)
    except pterodactyl_client.ApiException as e:
        print("Exception when calling ClientApi->client_permissions_get: %s\n" % e)
```
