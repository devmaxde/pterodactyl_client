...
[**__location_deletelocation**](LocationsLocationsApi.md#__location_deletelocation) | **DELETE** /application/locations/3 | [ /{location} ] Delete location
[**__location_locationdetails**](LocationsLocationsApi.md#__location_locationdetails) | **GET** /application/locations/1 | [ /{location} ] Location details
[**__updatelocation**](LocationsLocationsApi.md#__updatelocation) | **PATCH** /application/locations/1 | [ / ] Update location
...
# **__location_deletelocation**
> bool, date, datetime, dict, float, int, list, str, none_type __location_deletelocation(accept, content_type)
...
with pterodactyl_client.ApiClient(configuration) as api_client:
    ...
    try:
        # [ /{location} ] Delete location
        api_response = api_instance.__location_deletelocation(accept, content_type)
        pprint(api_response)
    except pterodactyl_client.ApiException as e:
        print("Exception when calling LocationsLocationsApi->__location_deletelocation: %s\n" % e)
```
...
# **__location_locationdetails**
> bool, date, datetime, dict, float, int, list, str, none_type __location_locationdetails(accept, content_type)
...
with pterodactyl_client.ApiClient(configuration) as api_client:
    ...
    try:
        # [ /{location} ] Location details
        api_response = api_instance.__location_locationdetails(accept, content_type)
        pprint(api_response)
    except pterodactyl_client.ApiException as e:
        print("Exception when calling LocationsLocationsApi->__location_locationdetails: %s\n" % e)
```
...
# **__updatelocation**
> bool, date, datetime, dict, float, int, list, str, none_type __updatelocation(accept, updatelocation_request)
...
with pterodactyl_client.ApiClient(configuration) as api_client:
    ...
    api_instance = locations_locations_api.LocationsLocationsApi(api_client)
    accept = "application/json" # str | 
    updatelocation_request = UpdatelocationRequest(None) # UpdatelocationRequest | 

    # example passing only required values which don't have defaults set
    try:
        # [ / ] Update location
        api_response = api_instance.__updatelocation(accept, updatelocation_request)
        pprint(api_response)
    except pterodactyl_client.ApiException as e:
        print("Exception when calling LocationsLocationsApi->__updatelocation: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **accept** | **str**|  |
 **updatelocation_request** | [**UpdatelocationRequest**](UpdatelocationRequest.md)|  |
