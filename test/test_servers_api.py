...
class TestServersApi(unittest.TestCase):
    ...
    def test_application_servers_externalserver_id_get(self):
        """Test case for application_servers_externalserver_id_get
    ...
    def test_application_serversserver_id_delete(self):
        """Test case for application_serversserver_id_delete

        [ /{server} ] Delete server  # noqa: E501
        """
        pass

    def test_application_serversserver_id_details_patch(self):
        """Test case for application_serversserver_id_details_patch

        [ /{server}/details ] Update details  # noqa: E501
        """
        pass

    def test_application_serversserver_id_force_delete(self):
        """Test case for application_serversserver_id_force_delete

        [ /{server}/{force?} ] Force delete server  # noqa: E501
        """
        pass

    def test_application_serversserver_id_get(self):
        """Test case for application_serversserver_id_get

        [ /{server} ] Server details  # noqa: E501
        """
        pass

    def test_application_serversserver_id_reinstall_post(self):
        """Test case for application_serversserver_id_reinstall_post

        [ /{server}/reinstall ] Reinstall server  # noqa: E501
        """
        pass

    def test_application_serversserver_id_startup_patch(self):
        """Test case for application_serversserver_id_startup_patch

        [ /{server}/startup ] Update startup  # noqa: E501
        """
        pass

    def test_application_serversserver_id_suspend_post(self):
        """Test case for application_serversserver_id_suspend_post

        [ /{server}/suspend ] Suspend server  # noqa: E501
        """
        pass

    def test_application_serversserver_id_unsuspend_post(self):
        """Test case for application_serversserver_id_unsuspend_post
