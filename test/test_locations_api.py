...
class TestLocationsApi(unittest.TestCase):
    ...
    def test_application_locationslocation_id_get(self):
        """Test case for application_locationslocation_id_get

        [ /{location} ] Location details  # noqa: E501
        """
        pass

    def test_application_locationslocation_id_patch(self):
        """Test case for application_locationslocation_id_patch
