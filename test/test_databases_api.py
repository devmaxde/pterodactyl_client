...
class TestDatabasesApi(unittest.TestCase):
    ...
    def test_client_serversserver_id_databases_get(self):
        """Test case for client_serversserver_id_databases_get

        [ / ] List databases  # noqa: E501
        """
        pass

    def test_client_serversserver_id_databases_post(self):
        """Test case for client_serversserver_id_databases_post

        [ / ] Create database  # noqa: E501
        """
        pass

    def test_client_serversserver_id_databasesdatabase_id_delete(self):
        """Test case for client_serversserver_id_databasesdatabase_id_delete

        [ /{database} ] Delete database  # noqa: E501
        """
        pass

    def test_client_serversserver_id_databasesdatabase_id_rotate_password_post(self):
        """Test case for client_serversserver_id_databasesdatabase_id_rotate_password_post
