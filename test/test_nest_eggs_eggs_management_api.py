...
from pterodactyl_client.api.nest_eggs_eggs_management_api import NestEggsEggsManagementApi  # noqa: E501


class TestNestEggsEggsManagementApi(unittest.TestCase):
    """NestEggsEggsManagementApi unit test stubs"""

    def setUp(self):
        self.api = NestEggsEggsManagementApi()  # noqa: E501

    def tearDown(self):
        pass

    def test___egg_eggdetails(self):
        """Test case for __egg_eggdetails

        [ /{egg} ] Egg details  # noqa: E501
        """
        pass

    def test___listeggs(self):
        """Test case for __listeggs
