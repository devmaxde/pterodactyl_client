...
class TestNodesApi(unittest.TestCase):
    ...
    def test_application_nodesnode_id_delete(self):
        """Test case for application_nodesnode_id_delete

        [ /{node} ] Delete node  # noqa: E501
        """
        pass

    def test_application_nodesnode_id_get(self):
        """Test case for application_nodesnode_id_get

        [ /{node} ] Node details  # noqa: E501
        """
        pass

    def test_application_nodesnode_id_patch(self):
        """Test case for application_nodesnode_id_patch
