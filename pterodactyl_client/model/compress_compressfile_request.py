...
class CompressCompressfileRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, files, root, *args, **kwargs):  # noqa: E501
        """CompressCompressfileRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, files, root, *args, **kwargs):  # noqa: E501
        """CompressCompressfileRequest - a model defined in OpenAPI
