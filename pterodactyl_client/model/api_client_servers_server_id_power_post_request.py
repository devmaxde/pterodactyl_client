...
class ApiClientServersServerIdPowerPostRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApiClientServersServerIdPowerPostRequest - a model defined in OpenAPI
