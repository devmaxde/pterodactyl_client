...
class CreateallocationsRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ip, ports, *args, **kwargs):  # noqa: E501
        """CreateallocationsRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, ip, ports, *args, **kwargs):  # noqa: E501
        """CreateallocationsRequest - a model defined in OpenAPI
