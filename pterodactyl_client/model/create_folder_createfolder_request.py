...
class CreateFolderCreatefolderRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, root, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, root, *args, **kwargs):  # noqa: E501
        """CreateFolderCreatefolderRequest - a model defined in OpenAPI
