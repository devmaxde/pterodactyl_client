...
class ScheduletaskstaskUpdatetaskRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action, payload, time_offset, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, action, payload, time_offset, *args, **kwargs):  # noqa: E501
        """ScheduletaskstaskUpdatetaskRequest - a model defined in OpenAPI
