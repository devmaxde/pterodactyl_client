...
class CreatedatabaseRequest1(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, database, remote, *args, **kwargs):  # noqa: E501
        """CreatedatabaseRequest1 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, database, remote, *args, **kwargs):  # noqa: E501
        """CreatedatabaseRequest1 - a model defined in OpenAPI
