...
class ApiKeysCreateAPIkeyRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, allowed_ips, description, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, allowed_ips, description, *args, **kwargs):  # noqa: E501
        """ApiKeysCreateAPIkeyRequest - a model defined in OpenAPI
