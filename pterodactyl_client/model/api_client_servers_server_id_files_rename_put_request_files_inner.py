...
class ApiClientServersServerIdFilesRenamePutRequestFilesInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApiClientServersServerIdFilesRenamePutRequestFilesInner - a model defined in OpenAPI
