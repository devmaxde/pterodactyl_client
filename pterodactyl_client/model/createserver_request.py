...
class CreateserverRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, allocation, docker_image, egg, environment, feature_limits, limits, name, startup, user, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, allocation, docker_image, egg, environment, feature_limits, limits, name, startup, user, *args, **kwargs):  # noqa: E501
        """CreateserverRequest - a model defined in OpenAPI
