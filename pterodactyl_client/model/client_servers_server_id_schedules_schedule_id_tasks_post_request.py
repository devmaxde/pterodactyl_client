...
class ClientServersServerIdSchedulesScheduleIdTasksPostRequest(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ClientServersServerIdSchedulesScheduleIdTasksPostRequest - a model defined in OpenAPI
