...
class CreatescheduleRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, day_of_month, day_of_week, hour, is_active, minute, name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, day_of_month, day_of_week, hour, is_active, minute, name, *args, **kwargs):  # noqa: E501
        """CreatescheduleRequest - a model defined in OpenAPI
