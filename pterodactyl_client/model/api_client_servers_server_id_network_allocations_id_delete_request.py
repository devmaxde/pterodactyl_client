...
class ApiClientServersServerIdNetworkAllocationsIdDeleteRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApiClientServersServerIdNetworkAllocationsIdDeleteRequest - a model defined in OpenAPI
