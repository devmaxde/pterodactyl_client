...
class ClientServersServerIdSchedulesScheduleIdTasksTaskIdPostRequest(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ClientServersServerIdSchedulesScheduleIdTasksTaskIdPostRequest - a model defined in OpenAPI
