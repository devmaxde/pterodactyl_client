...
class ApiApplicationNodesIdAllocationsGetRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApiApplicationNodesIdAllocationsGetRequest - a model defined in OpenAPI
