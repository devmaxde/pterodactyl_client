...
class ScheduleUpdatescheduleRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, day_of_month, day_of_week, hour, minute, name, *args, **kwargs):  # noqa: E501
        """ScheduleUpdatescheduleRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, day_of_month, day_of_week, hour, minute, name, *args, **kwargs):  # noqa: E501
        """ScheduleUpdatescheduleRequest - a model defined in OpenAPI
