...
class CreateUserRequest1(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, permissions, *args, **kwargs):  # noqa: E501
        """CreateUserRequest1 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, permissions, *args, **kwargs):  # noqa: E501
        """CreateUserRequest1 - a model defined in OpenAPI
