...
class CreatenodeRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, daemon_listen, daemon_sftp, disk, disk_overallocate, fqdn, location_id, memory, memory_overallocate, name, scheme, upload_size, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, daemon_listen, daemon_sftp, disk, disk_overallocate, fqdn, location_id, memory, memory_overallocate, name, scheme, upload_size, *args, **kwargs):  # noqa: E501
        """CreatenodeRequest - a model defined in OpenAPI
