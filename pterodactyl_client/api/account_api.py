...
class AccountApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.account_api_keysapi_key_id_delete_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/account/api-keys/{api_key_id}',
                'operation_id': 'account_api_keysapi_key_id_delete',
                'http_method': 'DELETE',
                'servers': [
                    {
    ...
    def account_api_keysapi_key_id_delete(
        ...
        **kwargs
        ...
        >>> thread = api.account_api_keysapi_key_id_delete(accept, content_type, api_key_id, async_req=True)
        >>> result = thread.get()
