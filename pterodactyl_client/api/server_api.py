...
class ServerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.client_serversserver_id_command_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/{server_id}/command',
                'operation_id': 'client_serversserver_id_command_post',
                'http_method': 'POST',
                'servers': [
                    {
            ...
            params_map={
                'all': [
                    'accept',
                    'server_id',
                    'client_servers_server_id_command_post_request',
                ],
                'required': [
                    'accept',
                    'server_id',
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'server_id': 'path',
                    'client_servers_server_id_command_post_request': 'body',
                },
        ...
        self.client_serversserver_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/{server_id}',
                'operation_id': 'client_serversserver_id_get',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.client_serversserver_id_power_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/{server_id}/power',
                'operation_id': 'client_serversserver_id_power_post',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            params_map={
                'all': [
                    'accept',
                    'server_id',
                    'client_servers_server_id_power_post_request',
                ],
                'required': [
                    'accept',
                    'server_id',
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'server_id': 'path',
                    'client_servers_server_id_power_post_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.client_serversserver_id_resources_get_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/{server_id}/resources',
                'operation_id': 'client_serversserver_id_resources_get',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.client_serversserver_id_websocket_get_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/{server_id}/websocket',
                'operation_id': 'client_serversserver_id_websocket_get',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
    ...
    def client_serversserver_id_command_post(
        self,
        accept,
        server_id,
        client_servers_server_id_command_post_request,
        **kwargs
        ...
        >>> thread = api.client_serversserver_id_command_post(accept, server_id, client_servers_server_id_command_post_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            server_id (str): 
            client_servers_server_id_command_post_request (ClientServersServerIdCommandPostRequest): 
        ...
        kwargs['server_id'] = \
            server_id
        kwargs['client_servers_server_id_command_post_request'] = \
            client_servers_server_id_command_post_request
        return self.client_serversserver_id_command_post_endpoint.call_with_http_info(**kwargs)

    def client_serversserver_id_get(
        self,
        accept,
        content_type,
        server_id,
        **kwargs
        ...
        >>> thread = api.client_serversserver_id_get(accept, content_type, server_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['server_id'] = \
            server_id
        return self.client_serversserver_id_get_endpoint.call_with_http_info(**kwargs)

    def client_serversserver_id_power_post(
        self,
        accept,
        server_id,
        client_servers_server_id_power_post_request,
        **kwargs
        ...
        >>> thread = api.client_serversserver_id_power_post(accept, server_id, client_servers_server_id_power_post_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            server_id (str): 
            client_servers_server_id_power_post_request (ClientServersServerIdPowerPostRequest): 
        ...
        kwargs['server_id'] = \
            server_id
        kwargs['client_servers_server_id_power_post_request'] = \
            client_servers_server_id_power_post_request
        return self.client_serversserver_id_power_post_endpoint.call_with_http_info(**kwargs)

    def client_serversserver_id_resources_get(
        self,
        accept,
        content_type,
        server_id,
        **kwargs
        ...
        >>> thread = api.client_serversserver_id_resources_get(accept, content_type, server_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['server_id'] = \
            server_id
        return self.client_serversserver_id_resources_get_endpoint.call_with_http_info(**kwargs)

    def client_serversserver_id_websocket_get(
        self,
        accept,
        content_type,
        server_id,
        **kwargs
        ...
        >>> thread = api.client_serversserver_id_websocket_get(accept, content_type, server_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['server_id'] = \
            server_id
        return self.client_serversserver_id_websocket_get_endpoint.call_with_http_info(**kwargs)
