...
class NodesNodesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.__node_configuration_nodeconfiguration_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/nodes/1/configuration',
                'operation_id': '__node_configuration_nodeconfiguration',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__node_deletenode_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/nodes/1',
                'operation_id': '__node_deletenode',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__node_nodedetails_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ...
                'endpoint_path': '/application/nodes/1',
                'operation_id': '__node_nodedetails',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__node_updatenode_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ...
                'endpoint_path': '/application/nodes/1',
                'operation_id': '__node_updatenode',
                'http_method': 'PATCH',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
    ...
    def __node_configuration_nodeconfiguration(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__node_configuration_nodeconfiguration(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__node_configuration_nodeconfiguration_endpoint.call_with_http_info(**kwargs)

    def __node_deletenode(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__node_deletenode(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__node_deletenode_endpoint.call_with_http_info(**kwargs)

    def __node_nodedetails(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__node_nodedetails(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__node_nodedetails_endpoint.call_with_http_info(**kwargs)

    def __node_updatenode(
        self,
        accept,
        node_updatenode_request,
        **kwargs
        ...
        >>> thread = api.__node_updatenode(accept, node_updatenode_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            node_updatenode_request (NodeUpdatenodeRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['node_updatenode_request'] = \
            node_updatenode_request
        return self.__node_updatenode_endpoint.call_with_http_info(**kwargs)
