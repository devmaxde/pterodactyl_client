...
class FilesFileManagerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.__compress_compressfile_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/compress',
                'operation_id': '__compress_compressfile',
                'http_method': 'POST',
                'servers': [
                    {
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'compress_compressfile_request': 'body',
                },
        ...
        self.__contents_getfilecontents_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/contents',
                'operation_id': '__contents_getfilecontents',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__copy_copyfile_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/copy',
                'operation_id': '__copy_copyfile',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__create_folder_createfolder_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/create-folder',
                'operation_id': '__create_folder_createfolder',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            params_map={
                'all': [
                    'accept',
                    'create_folder_createfolder_request',
                ],
                'required': [
                    'accept',
                    'create_folder_createfolder_request',
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'create_folder_createfolder_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.__decompress_decompressfile_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/decompress',
                'operation_id': '__decompress_decompressfile',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            params_map={
                'all': [
                    'accept',
                    'decompress_decompressfile_request',
                ],
                'required': [
                    'accept',
                    'decompress_decompressfile_request',
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'decompress_decompressfile_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.__delete_deletefile_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/delete',
                'operation_id': '__delete_deletefile',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'delete_deletefile_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.__download_downloadfile_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/download',
                'operation_id': '__download_downloadfile',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__list_listfiles_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/list',
                'operation_id': '__list_listfiles',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__rename_renamefile_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/rename',
                'operation_id': '__rename_renamefile',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'rename_renamefile_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.__upload_uploadfile_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/upload',
                'operation_id': '__upload_uploadfile',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__write_writefile_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/files/write',
                'operation_id': '__write_writefile',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
    ...
    def __compress_compressfile(
        ...
        **kwargs
        ...
        >>> thread = api.__compress_compressfile(accept, compress_compressfile_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            compress_compressfile_request (CompressCompressfileRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['compress_compressfile_request'] = \
            compress_compressfile_request
        return self.__compress_compressfile_endpoint.call_with_http_info(**kwargs)

    def __contents_getfilecontents(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__contents_getfilecontents(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__contents_getfilecontents_endpoint.call_with_http_info(**kwargs)
    ...
    def __copy_copyfile(
        ...
        **kwargs
        ...
        >>> thread = api.__copy_copyfile(accept, copy_copyfile_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            copy_copyfile_request (CopyCopyfileRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['copy_copyfile_request'] = \
            copy_copyfile_request
        return self.__copy_copyfile_endpoint.call_with_http_info(**kwargs)

    def __create_folder_createfolder(
        self,
        accept,
        create_folder_createfolder_request,
        **kwargs
        ...
        >>> thread = api.__create_folder_createfolder(accept, create_folder_createfolder_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            create_folder_createfolder_request (CreateFolderCreatefolderRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['create_folder_createfolder_request'] = \
            create_folder_createfolder_request
        return self.__create_folder_createfolder_endpoint.call_with_http_info(**kwargs)

    def __decompress_decompressfile(
        self,
        accept,
        decompress_decompressfile_request,
        **kwargs
        ...
        >>> thread = api.__decompress_decompressfile(accept, decompress_decompressfile_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            decompress_decompressfile_request (DecompressDecompressfileRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['decompress_decompressfile_request'] = \
            decompress_decompressfile_request
        return self.__decompress_decompressfile_endpoint.call_with_http_info(**kwargs)

    def __delete_deletefile(
        self,
        accept,
        delete_deletefile_request,
        **kwargs
        ...
        >>> thread = api.__delete_deletefile(accept, delete_deletefile_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            delete_deletefile_request (DeleteDeletefileRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['delete_deletefile_request'] = \
            delete_deletefile_request
        return self.__delete_deletefile_endpoint.call_with_http_info(**kwargs)

    def __download_downloadfile(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__download_downloadfile(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__download_downloadfile_endpoint.call_with_http_info(**kwargs)

    def __list_listfiles(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__list_listfiles(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__list_listfiles_endpoint.call_with_http_info(**kwargs)

    def __rename_renamefile(
        self,
        accept,
        rename_renamefile_request,
        **kwargs
        ...
        >>> thread = api.__rename_renamefile(accept, rename_renamefile_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            rename_renamefile_request (RenameRenamefileRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['rename_renamefile_request'] = \
            rename_renamefile_request
        return self.__rename_renamefile_endpoint.call_with_http_info(**kwargs)

    def __upload_uploadfile(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__upload_uploadfile(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__upload_uploadfile_endpoint.call_with_http_info(**kwargs)

    def __write_writefile(
        self,
        accept,
        body,
        **kwargs
        ...
        >>> thread = api.__write_writefile(accept, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['body'] = \
            body
        return self.__write_writefile_endpoint.call_with_http_info(**kwargs)
