...
class StartupApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.client_serversserver_id_startup_get_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/{server_id}/startup',
                'operation_id': 'client_serversserver_id_startup_get',
                'http_method': 'GET',
                'servers': [
                    {
        ...
        self.client_serversserver_id_startup_variable_put_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/{server_id}/startup/variable',
                'operation_id': 'client_serversserver_id_startup_variable_put',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            params_map={
                'all': [
                    'accept',
                    'server_id',
                    'client_servers_server_id_startup_variable_put_request',
                ],
                'required': [
                    'accept',
                    'server_id',
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'server_id': 'path',
                    'client_servers_server_id_startup_variable_put_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def client_serversserver_id_startup_get(
        self,
        accept,
        server_id,
        **kwargs
        ...
        >>> thread = api.client_serversserver_id_startup_get(accept, server_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['server_id'] = \
            server_id
        return self.client_serversserver_id_startup_get_endpoint.call_with_http_info(**kwargs)

    def client_serversserver_id_startup_variable_put(
        self,
        accept,
        server_id,
        client_servers_server_id_startup_variable_put_request,
        **kwargs
        ...
        >>> thread = api.client_serversserver_id_startup_variable_put(accept, server_id, client_servers_server_id_startup_variable_put_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            server_id (str): 
            client_servers_server_id_startup_variable_put_request (ClientServersServerIdStartupVariablePutRequest): 
        ...
        kwargs['server_id'] = \
            server_id
        kwargs['client_servers_server_id_startup_variable_put_request'] = \
            client_servers_server_id_startup_variable_put_request
        return self.client_serversserver_id_startup_variable_put_endpoint.call_with_http_info(**kwargs)
