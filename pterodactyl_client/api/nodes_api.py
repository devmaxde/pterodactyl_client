...
class NodesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.application_nodes_get_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'application_nodes_get',
                'http_method': 'GET',
                'servers': [
                    {
        ...
        self.application_nodes_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ...
                'endpoint_path': '/application/nodes',
                'operation_id': 'application_nodes_post',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            params_map={
                'all': [
                    'accept',
                    'application_nodes_post_request',
                ],
                'required': [
                    'accept',
                    'application_nodes_post_request',
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'application_nodes_post_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def application_nodes_get(
        ...
        **kwargs
        ...
        >>> thread = api.application_nodes_get(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.application_nodes_get_endpoint.call_with_http_info(**kwargs)

    def application_nodes_post(
        self,
        accept,
        application_nodes_post_request,
        **kwargs
        ...
        >>> thread = api.application_nodes_post(accept, application_nodes_post_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            application_nodes_post_request (ApplicationNodesPostRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['application_nodes_post_request'] = \
            application_nodes_post_request
        return self.application_nodes_post_endpoint.call_with_http_info(**kwargs)
