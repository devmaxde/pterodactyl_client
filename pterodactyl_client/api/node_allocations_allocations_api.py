...
class NodeAllocationsAllocationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.__allocation_deleteallocation_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/nodes/1/allocations/18',
                'operation_id': '__allocation_deleteallocation',
                'http_method': 'DELETE',
                'servers': [
                    {
        ...
        self.__createallocations_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/nodes/1/allocations',
                'operation_id': '__createallocations',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'createallocations_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.__listallocations_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ...
                'endpoint_path': '/application/nodes/1/allocations',
                'operation_id': '__listallocations',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
    ...
    def __allocation_deleteallocation(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__allocation_deleteallocation(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__allocation_deleteallocation_endpoint.call_with_http_info(**kwargs)

    def __createallocations(
        self,
        accept,
        createallocations_request,
        **kwargs
        ...
        >>> thread = api.__createallocations(accept, createallocations_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            createallocations_request (CreateallocationsRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['createallocations_request'] = \
            createallocations_request
        return self.__createallocations_endpoint.call_with_http_info(**kwargs)

    def __listallocations(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__listallocations(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__listallocations_endpoint.call_with_http_info(**kwargs)
