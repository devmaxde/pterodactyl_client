...
class DatabasesDatabasesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.__database_rotate_password_rotatepassword_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/databases/bEY4yAD5/rotate-password',
                'operation_id': '__database_rotate_password_rotatepassword',
                'http_method': 'POST',
                'servers': [
                    {
        ...
        self.delete__database_deletedatabase_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/databases/y9YVxO4V',
                'operation_id': 'delete__database_deletedatabase',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.get__listdatabases_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/1a7ce997/databases',
                'operation_id': 'get__listdatabases',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.post__createdatabase_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ...
                'endpoint_path': '/client/servers/1a7ce997/databases',
                'operation_id': 'post__createdatabase',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'post_createdatabase_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def __database_rotate_password_rotatepassword(
        self,
        accept,
        **kwargs
    ):
        ...
        >>> thread = api.__database_rotate_password_rotatepassword(accept, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['accept'] = \
            accept
        return self.__database_rotate_password_rotatepassword_endpoint.call_with_http_info(**kwargs)

    def delete__database_deletedatabase(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.delete__database_deletedatabase(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.delete__database_deletedatabase_endpoint.call_with_http_info(**kwargs)

    def get__listdatabases(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.get__listdatabases(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.get__listdatabases_endpoint.call_with_http_info(**kwargs)

    def post__createdatabase(
        self,
        accept,
        post_createdatabase_request,
        **kwargs
        ...
        >>> thread = api.post__createdatabase(accept, post_createdatabase_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            post_createdatabase_request (PostCreatedatabaseRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['post_createdatabase_request'] = \
            post_createdatabase_request
        return self.post__createdatabase_endpoint.call_with_http_info(**kwargs)
