...
class DatabaseManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.application_serversserver_id_databases_get_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/servers/{server_id}/databases',
                'operation_id': 'application_serversserver_id_databases_get',
                'http_method': 'GET',
                'servers': [
                    {
        ...
        self.application_serversserver_id_databases_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ...
                'endpoint_path': '/application/servers/{server_id}/databases',
                'operation_id': 'application_serversserver_id_databases_post',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            params_map={
                'all': [
                    'accept',
                    'server_id',
                    'application_servers_server_id_databases_post_request',
                ],
                'required': [
                    'accept',
                    'server_id',
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'server_id': 'path',
                    'application_servers_server_id_databases_post_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.application_serversserver_id_databasesdatabase_id_delete_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/servers/{server_id}/databases/{database_id}',
                'operation_id': 'application_serversserver_id_databasesdatabase_id_delete',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.application_serversserver_id_databasesdatabase_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ...
                'endpoint_path': '/application/servers/{server_id}/databases/{database_id}',
                'operation_id': 'application_serversserver_id_databasesdatabase_id_get',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.application_serversserver_id_databasesdatabase_id_reset_password_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/servers/{server_id}/databases/{database_id}/reset-password',
                'operation_id': 'application_serversserver_id_databasesdatabase_id_reset_password_post',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
    ...
    def application_serversserver_id_databases_get(
        self,
        id,
        id2,
        content_type,
        ...
        **kwargs
        ...
        >>> thread = api.application_serversserver_id_databases_get(id, id2, content_type, server_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['server_id'] = \
            server_id
        return self.application_serversserver_id_databases_get_endpoint.call_with_http_info(**kwargs)

    def application_serversserver_id_databases_post(
        self,
        accept,
        server_id,
        application_servers_server_id_databases_post_request,
        **kwargs
        ...
        >>> thread = api.application_serversserver_id_databases_post(accept, server_id, application_servers_server_id_databases_post_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            server_id (str): 
            application_servers_server_id_databases_post_request (ApplicationServersServerIdDatabasesPostRequest): 
        ...
        kwargs['server_id'] = \
            server_id
        kwargs['application_servers_server_id_databases_post_request'] = \
            application_servers_server_id_databases_post_request
        return self.application_serversserver_id_databases_post_endpoint.call_with_http_info(**kwargs)

    def application_serversserver_id_databasesdatabase_id_delete(
        self,
        accept,
        content_type,
        server_id,
        ...
        **kwargs
        ...
        >>> thread = api.application_serversserver_id_databasesdatabase_id_delete(accept, content_type, server_id, database_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['database_id'] = \
            database_id
        return self.application_serversserver_id_databasesdatabase_id_delete_endpoint.call_with_http_info(**kwargs)

    def application_serversserver_id_databasesdatabase_id_get(
        self,
        accept,
        content_type,
        server_id,
        ...
        **kwargs
        ...
        >>> thread = api.application_serversserver_id_databasesdatabase_id_get(accept, content_type, server_id, database_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['database_id'] = \
            database_id
        return self.application_serversserver_id_databasesdatabase_id_get_endpoint.call_with_http_info(**kwargs)

    def application_serversserver_id_databasesdatabase_id_reset_password_post(
        self,
        accept,
        content_type,
        server_id,
        ...
        **kwargs
        ...
        >>> thread = api.application_serversserver_id_databasesdatabase_id_reset_password_post(accept, content_type, server_id, database_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['database_id'] = \
            database_id
        return self.application_serversserver_id_databasesdatabase_id_reset_password_post_endpoint.call_with_http_info(**kwargs)
