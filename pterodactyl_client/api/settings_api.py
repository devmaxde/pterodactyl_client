...
class SettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.client_serversserver_id_settings_reinstall_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/{server_id}/settings/reinstall',
                'operation_id': 'client_serversserver_id_settings_reinstall_post',
                'http_method': 'POST',
                'servers': [
                    {
        ...
        self.client_serversserver_id_settings_rename_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/client/servers/{server_id}/settings/rename',
                'operation_id': 'client_serversserver_id_settings_rename_post',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
            ...
            params_map={
                'all': [
                    'accept',
                    'server_id',
                    'client_servers_server_id_settings_rename_post_request',
                ],
                'required': [
                    'accept',
                    'server_id',
            ...
            root_map={
                ...
                'location_map': {
                    'accept': 'header',
                    'server_id': 'path',
                    'client_servers_server_id_settings_rename_post_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def client_serversserver_id_settings_reinstall_post(
        self,
        accept,
        server_id,
        ...
        **kwargs
        ...
        >>> thread = api.client_serversserver_id_settings_reinstall_post(accept, server_id, content_type="application/json", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['server_id'] = \
            server_id
        return self.client_serversserver_id_settings_reinstall_post_endpoint.call_with_http_info(**kwargs)

    def client_serversserver_id_settings_rename_post(
        self,
        accept,
        server_id,
        client_servers_server_id_settings_rename_post_request,
        **kwargs
        ...
        >>> thread = api.client_serversserver_id_settings_rename_post(accept, server_id, client_servers_server_id_settings_rename_post_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            server_id (str): 
            client_servers_server_id_settings_rename_post_request (ClientServersServerIdSettingsRenamePostRequest): 
        ...
        kwargs['server_id'] = \
            server_id
        kwargs['client_servers_server_id_settings_rename_post_request'] = \
            client_servers_server_id_settings_rename_post_request
        return self.client_serversserver_id_settings_rename_post_endpoint.call_with_http_info(**kwargs)
