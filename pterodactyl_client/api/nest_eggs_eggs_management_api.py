...
class NestEggsEggsManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.__egg_eggdetails_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/nests/1/eggs/1',
                'operation_id': '__egg_eggdetails',
                'http_method': 'GET',
                'servers': [
                    {
        ...
        self.__listeggs_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/nests/1/eggs',
                'operation_id': '__listeggs',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
    ...
    def __egg_eggdetails(
        ...
        **kwargs
        ...
        >>> thread = api.__egg_eggdetails(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__egg_eggdetails_endpoint.call_with_http_info(**kwargs)
    ...
    def __listeggs(
        ...
        **kwargs
        ...
        >>> thread = api.__listeggs(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__listeggs_endpoint.call_with_http_info(**kwargs)
