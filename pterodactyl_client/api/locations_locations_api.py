...
class LocationsLocationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.__createlocation_endpoint = _Endpoint(
            settings={
        ...
        self.__listlocations_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
        ...
        self.__location_deletelocation_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/locations/3',
                'operation_id': '__location_deletelocation',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__location_locationdetails_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/locations/1',
                'operation_id': '__location_locationdetails',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
        ...
        self.__updatelocation_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
    ...
    def __createlocation(
        ...
        **kwargs
        ...
        >>> thread = api.__createlocation(accept, createlocation_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            createlocation_request (CreatelocationRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['createlocation_request'] = \
            createlocation_request
        return self.__createlocation_endpoint.call_with_http_info(**kwargs)
    ...
    def __listlocations(
        ...
        **kwargs
        ...
        >>> thread = api.__listlocations(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__listlocations_endpoint.call_with_http_info(**kwargs)

    def __location_deletelocation(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__location_deletelocation(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__location_deletelocation_endpoint.call_with_http_info(**kwargs)

    def __location_locationdetails(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__location_locationdetails(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__location_locationdetails_endpoint.call_with_http_info(**kwargs)

    def __updatelocation(
        self,
        accept,
        updatelocation_request,
        **kwargs
        ...
        >>> thread = api.__updatelocation(accept, updatelocation_request, async_req=True)
        >>> result = thread.get()

        Args:
            accept (str): 
            updatelocation_request (UpdatelocationRequest): 
        ...
        kwargs['accept'] = \
            accept
        kwargs['updatelocation_request'] = \
            updatelocation_request
        return self.__updatelocation_endpoint.call_with_http_info(**kwargs)
