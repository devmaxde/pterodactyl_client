...
class NestsNestsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.__listnests_endpoint = _Endpoint(
            settings={
        ...
        self.__nest_nestdetails_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/application/nests/1',
                'operation_id': '__nest_nestdetails',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pterodactyl.file.properties/api",
    ...
    def __listnests(
        ...
        **kwargs
        ...
        >>> thread = api.__listnests(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__listnests_endpoint.call_with_http_info(**kwargs)

    def __nest_nestdetails(
        self,
        accept,
        content_type,
        **kwargs
        ...
        >>> thread = api.__nest_nestdetails(accept, content_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['content_type'] = \
            content_type
        return self.__nest_nestdetails_endpoint.call_with_http_info(**kwargs)
